...
if not log_file:
    # If not specified, check if there is a task ID (from session or workspace directory name)
    ...
    if task_id:
        ...
        # If no task ID, create a job_ID format log filename using timestamp
