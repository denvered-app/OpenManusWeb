...
# Register custom log handler to categorize logs by session ID
class SessionLogHandler:
    ...
    def __call__(self, record):
        ...
        # Pass the record along to continue the processing chain
        return True

class SimpleLogCapture:
    """Simple log capturer, provides logger-like interface"""
    def __init__(self, session_id: str):
        self.session_id = session_id
...
def capture_session_logs(session_id: str):
    ...
    Returns a SimpleLogCapture instance instead of directly returning a log list
    """
    ...
    try:
        ...
        # Remove temporarily added handler
